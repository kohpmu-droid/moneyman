...
**כן:** מייצר מודעה מלאה (טקסט + תמונה מעוצבת) מבקשה חופשית בעברית, מעלה מדיה, יוצר קמפיין/ad set/מודעה, יוצר ומחבר טופס לידים, ברירת מחדל PAUSED, מצב dry-run, ומסנכרן לידים אוטומטית ל-Google Sheet (חסין כפילויות).
